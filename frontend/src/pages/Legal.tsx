      ...
      <article className="clay-card p-7 sm:p-12">
        ...
        {isPrivacy ? (
          <div className="mt-10 space-y-8 text-sm sm:text-base leading-7 text-zinc-300">
            ...
            <section><h2 className="text-xl font-bold text-white mb-2">Third-party services</h2><p>FilmedIn relies on Google for authentication, TMDB for entertainment metadata, MongoDB for application data, Cloudinary for uploads, and Vercel for hosting. Their own policies apply to information they process.</p></section>
          </div>
        ) : (
          <div className="mt-10 space-y-8 text-sm sm:text-base leading-7 text-zinc-300">
