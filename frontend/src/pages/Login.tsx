        ...
        <div className="order-2 min-w-0 lg:order-none">
          <section className="relative min-h-[760px] overflow-hidden border-b border-white/[0.07] sm:min-h-screen">
            ...
            <div className="relative flex min-h-[760px] flex-col px-5 py-6 sm:min-h-screen sm:px-10 sm:py-9 lg:px-14">
              ...
              <div className="mt-auto max-w-4xl pb-10 sm:pb-16">
                <p className="text-xs font-bold uppercase tracking-[0.24em] text-[#d6b2e8]">Your cinematic identity</p>
          ...
          <section id="what-you-can-do" className="px-5 py-24 sm:px-10 sm:py-32 lg:px-14">
            <div className="mx-auto max-w-6xl">
              <p className="text-xs font-bold uppercase tracking-[0.22em] text-[#caa4df]">A library, not a database</p>
          ...
          <section className="px-5 py-24 sm:px-10 sm:py-32 lg:px-14">
            <div className="mx-auto max-w-6xl">
              <div className="grid gap-12 lg:grid-cols-2 lg:items-end"><div><p className="text-xs font-bold uppercase tracking-[0.22em] text-[#caa4df]">Follow the work</p><h2 className="mt-5 text-4xl font-black tracking-[-0.04em] sm:text-6xl">A cast name should lead somewhere.</h2></div><p className="text-base leading-8 text-zinc-400">Open anyone in a movie or show. See their biography, every major film and television credit, the roles they played, and jump directly into another title.</p></div>
          ...
          <section className="px-5 py-24 sm:px-10 sm:py-32 lg:px-14">
            <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[1fr_0.9fr] lg:items-center"><div><p className="text-xs font-bold uppercase tracking-[0.22em] text-[#caa4df]">Taste is better shared</p><h2 className="mt-5 text-4xl font-black tracking-[-0.04em] sm:text-6xl">Find the overlap without losing yourself.</h2><p className="mt-6 max-w-xl text-base leading-8 text-zinc-400">Follow people whose taste you trust, open their collections, and create a Taste Blend to see what you both like and what you should watch together.</p></div><div className="rounded-[2rem] border border-white/[0.08] bg-[#151821] p-7"><div className="flex items-center justify-between"><div className="flex -space-x-3"><span className="h-12 w-12 rounded-full border-4 border-[#151821] bg-gradient-to-br from-[#caa4df] to-[#4f315f]" /><span className="h-12 w-12 rounded-full border-4 border-[#151821] bg-gradient-to-br from-amber-300 to-red-800" /></div><Users className="h-5 w-5 text-zinc-600" /></div><p className="mt-8 text-sm font-bold">Your Taste Blend</p><div className="mt-4 h-3 overflow-hidden rounded-full bg-white/[0.06]"><div className="h-full w-[78%] rounded-full bg-gradient-to-r from-[#9a6bc1] to-[#d6b2e8]" /></div><div className="mt-3 flex justify-between text-[10px] font-bold uppercase tracking-wider text-zinc-500"><span>Shared taste</span><span>78% match</span></div></div></div>
          </section>

          <section className="border-t border-white/[0.07] px-5 py-24 text-center sm:px-10 sm:py-32 lg:px-14"><Clapperboard className="mx-auto h-8 w-8 text-[#caa4df]" /><h2 className="mx-auto mt-7 max-w-3xl text-4xl font-black tracking-[-0.04em] sm:text-6xl">Your watch history deserves a better home.</h2><p className="mx-auto mt-6 max-w-xl text-base leading-8 text-zinc-400">Start with Google and build the movie-and-TV collection that actually reflects you.</p><a href="#sign-in" className="mt-8 inline-flex items-center gap-2 rounded-full bg-white px-6 py-3 text-xs font-bold text-zinc-950">Continue to sign in <ArrowRight className="h-4 w-4" /></a></section>
        </div>
